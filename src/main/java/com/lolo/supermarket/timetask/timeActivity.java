    ...
    public void activity(){
        ...
        while (iterator.hasNext()) {
                ...
                if(goods!=null){
                    ...
                    while (iterator1.hasNext()) {
                        ...
                        if(activity.getType().equals("折扣")){
                            ...
                            queryWrapper2.eq("goodType",activity.getGoodBrand());
                            queryWrapper2.eq("goodBrand",activity.getGoodType());
                            queryWrapper2.eq("type","降价");
                            Activity activity1 = activityMapper.selectOne(queryWrapper2);
                            if(activity1 != null){
                                good.setActivityPrice(good.getPrice() * Double.parseDouble(activity.getCalculate())-Double.parseDouble(activity.getCalculate()));
                            }else{
                            // 该商品没有降过价，直接打折
            ...
            if((activity.getEndTime().equals(date)||activity.getEndTime().before(date))& activity.getStatus()==2){
                ...
                queryWrapper4.eq("goodType",activity.getGoodBrand());
                queryWrapper4.eq("goodBrand",activity.getGoodType());
